...
export const Dropdown: React.FC<DropdownProps> = ({
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      {isOpen && !disabled && (
        <div className="absolute top-full left-0 right-0 mt-1 bg-background-translucent backdrop-blur-sm border border-muted/80 rounded-md shadow-lg z-50 max-h-60 overflow-y-auto">
          {options.length === 0 ? (
